...
const CustomerModel = {
  ...
  getCustomers: async (
    ...
    try {
      ...
      if (status === "Others") {
        getQuery += ` AND c.status IN ('Partially Closed', 'Discontinued', 'Hold', 'Refund', 'Demo Completed', 'Video Given')`;
        countQuery += ` AND c.status IN ('Partially Closed', 'Discontinued', 'Hold', 'Refund', 'Demo Completed', 'Video Given')`;
      }
